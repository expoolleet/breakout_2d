...
void Game::init() {
    ...
    m_ballParticles = std::make_unique<ParticleEmitter>(m_context.textureManager->getTexture("ball"), 1000);
    ...
    m_collisionHitParticles = std::make_unique<ParticleEmitter>(m_context.textureManager->getTexture("ball"), 300);
