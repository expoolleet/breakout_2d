...
public:
	...
	void setVeñ4(std::string_view name, float x, float y, float z, float w);
	void setVeñ4(std::string_view name, float *vec);
	void setVeñ4(std::string_view name, const glm::vec4 &vec);
